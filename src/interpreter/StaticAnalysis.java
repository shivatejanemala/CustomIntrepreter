...
public class StaticAnalysis implements ASTVisitor {
	...
	public Object visitBlock(Block block, Object arg) throws Exception {
		...
		//int locaBlock = blockNo+1;
		for(Stat stat:statList) {
			if(stat instanceof StatIf) {
			...
			else if(labelOrGoto && stat instanceof StatGoto) {
				visitStatGoto((StatGoto)stat,arg);
			}
			else if(!labelOrGoto && stat instanceof StatLabel) {
				visitLabel((StatLabel)stat,blockNumber);
			}
		}
	...
	public Object visitStatGoto(StatGoto statGoto, Object arg) throws Exception {
		// TODO Auto-generated method stub
		StatLabel statlabel = symbolTable.get(statGoto,blockNo);
		statGoto.label=statlabel;
		return null;
	}
	...
	public Object visitChunk(Chunk chunk, Object arg) throws Exception {
		...
		blockNo = 0;
		visitBlock(block,arg);
		chunk.setSymbolTable(symbolTable);
		return null;
	}
	...
	public Object visitLabel(StatLabel statLabel, Object ar) throws Exception {
		// TODO Auto-generated method stub
		//statLabel.enclosingBlock = (Block)ar; 
		symbolTable.put(statLabel,(int)ar);
		return null;
	}
